...
- **ENTÃO** o sistema DEVE utilizar as constantes compiladas padrão `kDefaultFeedbackEdgeFunctionUrl` (apontando para `/functions/v1/app-feedback`) e `kDefaultBaseUrl` (apontando para `https://serving.arestaclimb.com`).
