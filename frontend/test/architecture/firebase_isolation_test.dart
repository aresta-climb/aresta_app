...
void main() {
  test('Apenas os arquivos dentro da pasta lib/services/firebase podem importar pacotes do Firebase', () {
    ...
    for (final file in dartFiles) {
      ...
      if (content.contains("import 'package:firebase_") || content.contains('import "package:firebase_')) {
    ...
    expect(
      infringingFiles,
      isEmpty,
      reason: 'Os seguintes arquivos estão violando a arquitetura isolada do Firebase importando os pacotes nativos do Firebase diretamente:\n${infringingFiles.join('\n')}\n'
