...
| `mapao_global_functions_test.dart` | `buildMapaoBody`, Interface do Mapa Global | Testa a criação e montagem interativa do Mapão Global, com interações de bottom sheet e navegação. |
