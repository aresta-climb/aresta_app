...
void main() {
  ...
  group('RemoteConfigService Initialize', () {
    ...
    test('initialize deve configurar defaults, baixar com fetchInterval=0, e depois restaurar fetchInterval=12h', () async {
      // Setup
      ...
      final capturedSettings = verify(() => mockFirebaseRemoteConfig.setConfigSettings(captureAny())).captured;
  ...
  group('Feature Flags Getters', () {
    test('Acessar recommendedVersion retorna valor do mock', () {
      ...
      when(() => mockFirebaseRemoteConfig.getInt('recommended_version')).thenReturn(42);
