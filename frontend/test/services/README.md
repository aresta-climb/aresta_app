...
| `p2p_test.dart` | `AmbientP2PService` e `P2PTransferManager` | Testes robustos da **Malha P2P Offline**. Valida a desserialização de payloads pesados em base64 e a resistência (fail-safes) do aplicativo a JSONs corrompidos, desconexões e mensagens arbitrárias recebidas pela rede Wi-Fi Direct. |
