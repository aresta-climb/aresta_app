...
void main() {
  group('MapHierarchyResolver', () {
    ...
    test(
      '1.2: Retorna Mapa de Grupo caso setorContext pertença a um grupoContext que possua mapas',
      () {
    ...
    test(
      '1.3: Retorna Mapa Geral caso não haja Mapa de Grupo, mas o Pico tenha mapasGerais',
      () {
    ...
    test('1.4: Retorna null caso não existam mapas de nível superior', () {
      ...
      final destA2 = MapHierarchyResolver.resolveUpDestination(pico: picoVazio);
