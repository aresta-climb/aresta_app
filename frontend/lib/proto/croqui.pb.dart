...
class Pico extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<ArquivoSetor>(10, _omitFieldNames ? '' : 'setores',
  ...
  /// Lista de setores de escalada contidos neste pico.
  @$pb.TagNumber(10)
  $pb.PbList<ArquivoSetor> get setores => $_getList(9);
}
...
class Setor extends $pb.GeneratedMessage {
  factory Setor({
    ...
    $core.Iterable<ArquivoSetor>? subSetores,
    ...
    if (subSetores != null) result.subSetores.addAll(subSetores);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<ArquivoSetor>(12, _omitFieldNames ? '' : 'subSetores',
        subBuilder: ArquivoSetor.create)
  ...
  /// Lista de sub-setores de escalada contidos nesse setor (ex: "Ninhos" em "G3"
  /// na "Serra do Cipó").
  @$pb.TagNumber(12)
  $pb.PbList<ArquivoSetor> get subSetores => $_getList(9);

  /// Mapas do setor.
  @$pb.TagNumber(13)
  $pb.PbList<Mapa> get mapas => $_getList(10);
}
...
class Mapa_PontoDeInteresse extends $pb.GeneratedMessage {
  ...
  /// Bounding box do ponto de interesse na imagem.
  @$pb.TagNumber(3)
...
/// Caixa de enquadramento / bounding box de parte da imagem.
