...
class ResumoCroqui extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        8, _omitFieldNames ? '' : 'thumbnail', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  /// Thumbnail do croqui (imagem em miniatura para prever croquis não baixados).
  @$pb.TagNumber(8)
  $core.List<$core.int> get thumbnail => $_getN(7);
  @$pb.TagNumber(8)
  set thumbnail($core.List<$core.int> value) => $_setBytes(7, value);
  @$pb.TagNumber(8)
