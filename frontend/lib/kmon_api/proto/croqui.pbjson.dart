...
final $typed_data.Uint8List croquiDescriptor = $convert.base64Decode(
    ...
    'eHRlcm5vcxgHIAMoCzIWLmFjZWNtZy5BcnF1aXZvRXh0ZXJub1IQYXJxdWl2b3NFeHRlcm5vcw'
    '==');
...
final $typed_data.Uint8List picoDescriptor = $convert.base64Decode(
    ...
    'YWRvcmVzGAkgAygLMhQuYWNlY21nLlBhdHJvY2luYWRvclIOcGF0cm9jaW5hZG9yZXMSLgoHc2'
    'V0b3JlcxgKIAMoCzIULmFjZWNtZy5BcnF1aXZvU2V0b3JSB3NldG9yZXM=');
...
final $typed_data.Uint8List setorDescriptor = $convert.base64Decode(
    ...
    'Y2VjbWcuRXNjYWxhZGFSCWVzY2FsYWRhcxI1CgtzdWJfc2V0b3JlcxgMIAMoCzIULmFjZWNtZy'
    '5BcnF1aXZvU2V0b3JSCnN1YlNldG9yZXM=');
...
final $typed_data.Uint8List mapaDescriptor = $convert.base64Decode(
    ...
    'BvbnRvRGVJbnRlcmVzc2VSEXBvbnRvc0RlSW50ZXJlc3NlGl8KEFBvbnRvRGVJbnRlcmVzc2US'
    'DgoCaWQYASABKAlSAmlkEhQKBWxhYmVsGAIgASgJUgVsYWJlbBIlCgNib3gYAyABKAsyEy5hY2'
    'VjbWcuQm91bmRpbmdCb3hSA2JveA==');
...
final $typed_data.Uint8List escaladaDescriptor = $convert.base64Decode(
    ...
    'aWFkYXNIAFIUdmlhTXVsdGlwbGFzRW5maWFkYXNCBgoEdGlwbw==');
...
final $typed_data.Uint8List viaMovelDescriptor = $convert.base64Decode(
    ...
    'aWN1bGRhZGUSQQoJZXhwb3NpY2FvGAMgASgOMiMuYWNlY21nLkdyYXVFeHBvc2ljYW8uR3JhdU'
    'V4cG9zaWNhb1IJZXhwb3NpY2FvEj4KC3RpcG9fcGFyZWRlGAQgASgOMh0uYWNlY21nLlRpcG9Q'
    'YXJlZGUuVGlwb1BhcmVkZVIKdGlwb1BhcmVkZRIaCghleHRlbnNhbxgFIAEoBVIIZXh0ZW5zYW'
    '8STgojcXVhbnRpZGFkZV9wcm90ZWNvZXNfaW50ZXJtZWRpYXJpYXMYBiABKAVSIXF1YW50aWRh'
    'ZGVQcm90ZWNvZXNJbnRlcm1lZGlhcmlhcxI+ChtxdWFudGlkYWRlX3Byb3RlY29lc19wYXJhZG'
    'EYByABKAVSGXF1YW50aWRhZGVQcm90ZWNvZXNQYXJhZGESKQoQcHJvdGVjb2VzX21vdmVpcxgI'
    'IAEoCVIPcHJvdGVjb2VzTW92ZWlzEiUKDnRpcG9fYW5jb3JhZ2VtGAkgASgJUg10aXBvQW5jb3'
    'JhZ2VtEiYKDmNvbnF1aXN0YWRvcmVzGAogAygJUg5jb25xdWlzdGFkb3JlcxIjCg1kYXRhX2Fi'
    'ZXJ0dXJhGAsgASgJUgxkYXRhQWJlcnR1cmESJwoPZGF0YV9tYW51dGVuY2FvGAwgASgJUg5kYX'
    'RhTWFudXRlbmNhbxIcCglkZXNjcmljYW8YDSABKAlSCWRlc2NyaWNhbxIkCg51cmxfdmlkZW9f'
    'YmV0YRgOIAEoCVIMdXJsVmlkZW9CZXRhEjAKFGNoYXZlX3BpeF9tYW51dGVuY2FvGA8gASgJUh'
    'JjaGF2ZVBpeE1hbnV0ZW5jYW8=');
...
final $typed_data.Uint8List viaMultiplasEnfiadasDescriptor = $convert.base64Decode(
    ...
    'EYFCABKAlSCGlkTm9NYXBhEkQKEWRpZmljdWxkYWRlX21lZGlhGAIgASgOMhcuYWNlY21nLkdy'
    'YXVWaWEuR3JhdVZpYVIQZGlmaWN1bGRhZGVNZWRpYRJGChJkaWZpY3VsZGFkZV9tYXhpbWEYAy'
    'ABKA4yFy5hY2VjbWcuR3JhdVZpYS5HcmF1VmlhUhFkaWZpY3VsZGFkZU1heGltYRJcChZkaWZp'
    'Y3VsZGFkZV9hcnRpZmljaWFsGAQgASgOMiUuYWNlY21nLkdyYXVBcnRpZmljaWFsLkdyYXVBcn'
    'RpZmljaWFsUhVkaWZpY3VsZGFkZUFydGlmaWNpYWwSXgofZGlmaWN1bGRhZGVfYXJ0aWZpY2lh'
    'bF9lbV9saXZyZRgFIAEoDjIXLmFjZWNtZy5HcmF1VmlhLkdyYXVWaWFSHGRpZmljdWxkYWRlQX'
    'J0aWZpY2lhbEVtTGl2cmUSQQoJZXhwb3NpY2FvGAYgASgOMiMuYWNlY21nLkdyYXVFeHBvc2lj'
    'YW8uR3JhdUV4cG9zaWNhb1IJZXhwb3NpY2FvEjkKB2R1cmFjYW8YByABKA4yHy5hY2VjbWcuR3'
    'JhdUR1cmFjYW8uR3JhdUR1cmFjYW9SB2R1cmFjYW8SJwoPbnVtZXJvX2VuZmlhZGFzGAggASgF'
    'Ug5udW1lcm9FbmZpYWRhcxIrChFjb21wcmltZW50b190b3RhbBgJIAEoBVIQY29tcHJpbWVudG'
    '9Ub3RhbBI6Chljb21wcmltZW50b19tYWlvcl9lbmZpYWRhGAogASgFUhdjb21wcmltZW50b01h'
    'aW9yRW5maWFkYRJ0Cht0aXBvX3ZpYV9tdWx0aXBsYXNfZW5maWFkYXMYCyABKA4yNS5hY2VjbW'
    'cuVmlhTXVsdGlwbGFzRW5maWFkYXMuVGlwb1ZpYU11bHRpcGxhc0VuZmlhZGFzUhh0aXBvVmlh'
    'TXVsdGlwbGFzRW5maWFkYXMSNwoXZXF1aXBhbWVudG9fcmVjb21lbmRhZG8YDCABKAlSFmVxdW'
    'lwYW1lbnRvUmVjb21lbmRhZG8SLAoIZW5maWFkYXMYDSADKAsyEC5hY2VjbWcuRXNjYWxhZGFS'
    'CGVuZmlhZGFzEhwKCWRlc2NyaWNhbxgOIAEoCVIJZGVzY3JpY2FvEiYKDmNvbnF1aXN0YWRvcm'
    'VzGA8gAygJUg5jb25xdWlzdGFkb3JlcxIjCg1kYXRhX2FiZXJ0dXJhGBAgASgJUgxkYXRhQWJl'
    'cnR1cmESJwoPZGF0YV9tYW51dGVuY2FvGBEgASgJUg5kYXRhTWFudXRlbmNhbxIkCg51cmxfdm'
    'lkZW9fYmV0YRgSIAEoCVIMdXJsVmlkZW9CZXRhEjAKFGNoYXZlX3BpeF9tYW51dGVuY2FvGBMg'
    'ASgJUhJjaGF2ZVBpeE1hbnV0ZW5jYW8iVAoYVGlwb1ZpYU11bHRpcGxhc0VuZmlhZGFzEg4KCk'
    'lOREVGSU5JRE8QABINCglUT0RBX0ZJWEEQARIJCgVNSVNUQRACEg4KClRPREFfTU9WRUwQAw==');
